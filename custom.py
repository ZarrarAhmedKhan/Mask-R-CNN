...
if not os.path.exists(f"{ROOT_DIR}/{checkpoints_dir}"):
  os.mkdir(f'{ROOT_DIR}/{checkpoints_dir}')

DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, checkpoints_dir)
...
class CustomDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "soccer_field")
...
def train(model):
    ...
    dataset_train.load_balloon(args.dataset, train_subset)
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_balloon(args.dataset, val_subset)
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        assert args.image or args.video,\
               "Provide --image or --video to show results"
    ...
    if args.command == "train":
        ...
        print("'{}' is not recognized. "
              "Use 'train' or 'splash' or 'show'".format(args.command))
